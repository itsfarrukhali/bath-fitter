// app/templates/create-template-modal.tsx
"use client";
...
interface Props {
  onTemplateCreated: (template: TemplateCategory) => void;
}

export default function CreateTemplateModal({ onTemplateCreated }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { data } = await axios.post("/api/template-categories", {
        name,
        slug,
        description,
      });
